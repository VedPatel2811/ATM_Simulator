...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
      ...
      carddetail.setBounds(100, 322, 200, 22);
      add(carddetail);
      
      JLabel number = new JLabel("XXXX-XXXX-XXXX-4507");
      ...
      pindetail.setBounds(100, 382, 200, 22);
      add(pindetail);
      
      JLabel pnum = new JLabel("XXXX");
      pnum.setFont(new Font("Raleway", Font.BOLD, 22));
      pnum.setBounds(350, 360, 200, 30);
      add(pnum);
      
      JLabel services = new JLabel("Services Required:");
      services.setFont(new Font("Raleway", Font.ITALIC, 22));
        ...
        if(ae.getSource() == submit){
            ...
            try{
               if(accountType.equals("")) {
                   JOptionPane.showMessageDialog(null, "Account type is Requireed:");
               }else{
                   Conn conn = new Conn();
