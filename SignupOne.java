...
public class SignupOne extends JFrame implements ActionListener{
    ...
    long random;
    JTextField nameTextField,fnameTextField, emailTextField, addressTextField, cityTextField,stateTextField,postalTextField;
    ...
    SignupOne() {
        ...
        JLabel marital = new JLabel("Marital Satatus: ");
        ...
        Postalcode.setBounds(100,590,200,30);
        add(Postalcode);
        
        postalTextField = new JTextField();
        postalTextField.setFont(new Font("Railway", Font.BOLD, 14));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            if (name.equals("")){
                ...
                Conn c = new Conn();
                String query = "insert into signup values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+state+"','"+postalcode+"')";
